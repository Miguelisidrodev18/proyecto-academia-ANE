...
<div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3">
    ...
    $modulos = [
        ...
        ['nombre' => 'Aula Virtual',     'ruta' => 'cursos.index',              'bg' => 'bg-purple-50', 'text' => 'text-purple-600', 'active' => true,  'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 10l4.553-2.069A1 1 0 0121 8.882v6.236a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z"/>'],
        ...
        ['nombre' => 'Reportes',         'ruta' => 'dashboard.reportes',        'bg' => 'bg-teal-50',   'text' => 'text-teal-600',   'active' => true,  'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/>'],
...
<div class="mt-6 bg-gradient-to-r from-[#082B59] to-[#30A9D9] rounded-2xl p-5 flex items-center gap-4">
    ...
    <div>
        <p class="text-white font-bold text-sm">Módulos activos: Alumnos · Matrículas · Pagos · Aula Virtual · Reportes</p>
        <p class="text-white/60 text-xs mt-0.5">
            Genera reportes de asistencia en Excel y PDF desde el módulo Reportes.
        </p>
    </div>
</div>
