    ...
    <div class="flex items-center gap-3 mb-6 flex-wrap">
        ...
        <div class="flex-1">
            <nav class="text-xs text-gray-400 mb-0.5">
                ...
                <a href="{{ route('planes.show', $plan) }}" class="hover:text-accent transition-colors">{{ $plan->nombre }}</a>
                <span class="mx-1">/</span><span class="text-gray-600">Editar</span>
            </nav>
            <h1 class="text-xl font-black text-primary-dark leading-none">Editar Plan</h1>
        </div>
    </div>
