...
<div class="max-w-3xl mx-auto">
    ...
    <div class="flex items-center gap-3 mb-6">
        ...
        <div>
            <h1 class="text-2xl font-black text-primary-dark">Editar Matrícula</h1>
            <p class="text-gray-400 text-sm">{{ $matricula->alumno->nombreCompleto() }} — {{ $matricula->plan->nombre }}</p>
        </div>
        <div class="ml-auto">
